...
{
    #region WebApiMonitorLog
    /// <summary>
    /// 监控日志对象
    /// </summary>
    public class WebApiMonitor
    {
        ...
        {
            return HttpContextClient.GetClientIP;
        }

        public string UserHost()
        {
            return HttpContextClient.Host;
        }

        public string UserBrowser()
        {
            return HttpContextClient.Browser;
        }

        public string UserRequest()
        {
            return HttpContextClient.UserRequest;
        }
    }
